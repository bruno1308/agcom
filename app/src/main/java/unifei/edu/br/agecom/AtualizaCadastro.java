...
public class AtualizaCadastro {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra("id")){
            ...
            try {
                ...
                try{
                    Cursor cursor = db.query(ReminderDbHelperCadastro.TABLE, columns, selection, selectionArgs, null, null, null);
    ...
    public void deletarCadastro(View view){
        ...
        builder.setMessage("Realmente deseja excluir esse cadastro?");
